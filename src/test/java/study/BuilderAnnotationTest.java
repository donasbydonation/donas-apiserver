...
class BuilderAnnotationTest {
	...
	void builderAnnotationDefaultValue1() {
		...
		Assertions.assertThat(hello.getAge()).isEqualTo(113);
	...
	void builderAnnotationDefaultValue2() {
		...
		Assertions.assertThat(hello.getAge()).isEqualTo(10);
		Assertions.assertThat(hello.getName()).isEqualTo("*hello*");
	}
	...
	@Test
	void builderAnnotationDefaultValue4() {
		Pojo hello = Pojo.builder().age(10).name("hello").build();
		Assertions.assertThat(hello.getAge()).isEqualTo(20);
	}
